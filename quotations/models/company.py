...
class Company(models.Model):
    icon_default = 'quotations/assets/img/台整logo.png'
    stamp_default = 'quotations/assets/img/台整stamp.png'
    ...
    icon = models.CharField(max_length=255, blank=True, null=True, default=icon_default)
    stamp = models.CharField(max_length=255, blank=True, null=True, default=stamp_default)
